...
# SQLALCHEMY_DATABASE_URL = f"postgresql://{settings.database_username}:{settings.database_password}@{settings.database_hostname}:{settings.database_port}/{settings.database_name} test" #local
...
def test_user(client):
    user_data = {"email": "local@gmail.com", "password": "1234"}
...
def test_user2(client):
    user_data = {"email": "next@gmail.com", "password": "1234"}
    res = client.post("/users/", json=user_data)
