...
while True:
    try:
        ...
        conn = psycopg2.connect(
            host="localhost",
            database="fastapi crud system",
            user="princewillingoo",
            password="1234",
...
my_posts = [
    {"title": "machine learning", "content": "machine can read and write", "id": 1},
    {"title": "data engineering", "content": "building relaible data system", "id": 2},
    {
        "title": "software engineering",
        "content": "building relaible software products",
        "id": 3,
    },
]
